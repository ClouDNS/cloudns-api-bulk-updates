...
function apiCall ($url, $data) {
	...
	curl_setopt($init, CURLOPT_USERAGENT, 'cloudns_test_reqest_xml_script/0.1 (+https://github.com/ClouDNS/cloudns-api-bulk-updates/blob/master/test_request_xml.php)');
